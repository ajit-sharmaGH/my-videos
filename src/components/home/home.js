    ...
    <div className="padding-1 bg-theme-changer home_container">
      <div className="front_page">
        ...
        <h3 className="home_description">
          {" "}
          Lorem ipsum dolor sit amet ipisicing elit.Obcaecati
          temporibus ducimus facere aliquid earum natus quidem error harum
         exercitationem, quas aliquam
          minima voluptas nemo sed.{" "}
